...
from models.modules import build_graph
...
def get_mesh_dict_path():
    cfg = get_cfg_defaults()
    abspath = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
    mesh_path = {'left': os.path.join(abspath, cfg.MISC.MESH_LEFT),
                  'right': os.path.join(abspath, cfg.MISC.MESH_RIGHT)}
    return mesh_path
